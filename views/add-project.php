            ...
            <div class="tile-body">
              <form method="POST">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="Enter project" name="project">
                </div>
                <div class="form-group">
                ...
                <div class="tile-footer">
                  <button class="btn btn-primary" type="submit" name="add"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add project</button>
                </div>
              </form>
            </div>
          </div>
