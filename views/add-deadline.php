...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Add deadline</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Add deadline</h3>
            <div class="tile-body">
              <form method="POST">
                ...
                <div class="tile-footer">
                  <button class="btn btn-primary" type="submit" name="add"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add deadline</button>
                </div>
              </form>
            </div>
          </div>
...
if(isset($_POST["add"])){
  ...
  if(addDeadline($information, $deadline)){
